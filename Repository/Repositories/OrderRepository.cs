...
namespace Repository.Repositories
{
    public class OrderRepository : RepositoryBase, IOrderRepository
    {
        ...
        {
            var url = $"{Controller}";
            var response = await WebService.Client.PostAsJsonAsync(url, new { order, orderDetails });
        ...
        public async Task<IValueResponse<ICollection<TicketDetailDto>>> ChargeAsync(int orderId, int orderNumber, int restaurantId, int cashierId, int paymentType)
        {
            ...
            var response = await WebService.Client.PutAsJsonAsync(url, new { orderId, orderNumber, cashierId, paymentType, restaurantId });
        ...
        public async Task<IResponse> CancelAsync(int orderId, int cashierId)
        {
            ...
            var response = await WebService.Client.PutAsJsonAsync(url, new { orderId, cashierId });
